---
title: "Get all user interests"
api: "GET https://trotter.francecentral.cloudapp.azure.com/api/user"
description: "This endpoint gets all the trips"
---
...
curl --location --request GET 'https://trotter.francecentral.cloudapp.azure.com/api/user' \
